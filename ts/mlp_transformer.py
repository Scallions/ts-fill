'''
@Author       : Scallions
@Date         : 2020-07-21 16:05:11
@LastEditors  : Scallions
@LastEditTime : 2020-08-01 15:35:09
@FilePath     : /gps-ts/ts/mlp_transformer.py
@Description  : 
'''
...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        idx = self.idxs[index]
        return self.tsd.loc[idx-pd.Timedelta(days=self.range_):idx+pd.Timedelta(days=self.range_),:].to_numpy(), self.tsg.loc[idx, :].to_numpy()
